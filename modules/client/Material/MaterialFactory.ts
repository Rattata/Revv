...
export class MaterialFactory {
    ...
    static getMountainMaterial (scene : BABYLON.Scene): BABYLON.Material {
        ...
        material.bumpTexture = new BABYLON.Texture("/res/n_rock.jpg", scene,false,false,BABYLON.Texture.NEAREST_SAMPLINGMODE)
    ...
    static getWaterMaterial (scene: BABYLON.Scene): BABYLON.Material{
        ...
        material.bumpTexture = new BABYLON.Texture("/res/n_ripple.png", scene,false,false,BABYLON.Texture.NEAREST_SAMPLINGMODE)
        material.bumpTexture.anisotropicFilteringLevel = 1
        //material.emissiveColor = new BABYLON.Color3(0.2, 0.2, 0.2);
    ...
    static getFlatlandMaterial (scene: BABYLON.Scene): BABYLON.Material{
        ...
        material.specularColor = new BABYLON.Color3(0, 0, 0);
        material.bumpTexture = new BABYLON.Texture("/res/n_dot.png", scene,false,false,BABYLON.Texture.NEAREST_SAMPLINGMODE)
        material.bumpTexture.anisotropicFilteringLevel = 1
        //material.emissiveColor = new BABYLON.Color3(0.2, 0.2, 0.2);
