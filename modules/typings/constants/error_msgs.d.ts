...
export declare const MISSING_INJECT_ANNOTATION: string;
export declare const CIRCULAR_DEPENDENCY: string;
export declare const NOT_IMPLEMENTED: string;
...
export declare const ARGUMENTS_LENGTH_MISMATCH_1: string;
export declare const ARGUMENTS_LENGTH_MISMATCH_2: string;
export declare const KERNEL_OPTIONS_MUST_BE_AN_OBJECT: string;
export declare const KERNEL_OPTIONS_INVALID_DEFAULT_SCOPE: string;
